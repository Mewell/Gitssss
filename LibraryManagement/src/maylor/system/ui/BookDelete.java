...
public class BookDelete extends javax.swing.JFrame {
		...
		if (id != null && !id.equals("")) {
			try {
				...
				if (book != null) {
					...
					JOptionPane.showMessageDialog(null, "∏√Õº È≤ª¥Ê‘⁄£°", "œ˚œ¢", 1);
				}
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (id != null && !id.equals("")) {
			try {
				flag = DAOFactory.getIBookDAOInstance().doDelete(
						id);
				if (!flag) {
					JOptionPane.showMessageDialog(null, "∏√Õº È≤ª¥Ê‘⁄£°", "œ˚œ¢", 1);
				}
			...
			if (flag) {
				JOptionPane.showMessageDialog(null, "…æ≥˝≥…π¶£°", "œ˚œ¢", 1);
			}
		} else {
			JOptionPane.showMessageDialog(null, "«ÎÃÓ–¥“™…æ≥˝µƒÕº È±‡∫≈£°", "œ˚œ¢", 1);
		}
	}
