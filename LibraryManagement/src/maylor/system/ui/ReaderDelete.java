...
public class ReaderDelete extends javax.swing.JFrame {
		...
		if (id != null && !id.equals("")) {
			try {
				...
				if (reader != null) {
					...
					JOptionPane.showMessageDialog(null, "∏√∂¡’ﬂ≤ª¥Ê‘⁄£°", "œ˚œ¢", 1);
				}
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (id != null && !id.equals("")) {
			try {
				flag = DAOFactory.getIReaderDAOInstance().doDelete(
						id);
				if (!flag) {
					JOptionPane.showMessageDialog(null, "∏√∂¡’ﬂ≤ª¥Ê‘⁄£°", "œ˚œ¢", 1);
				}
			...
			JOptionPane.showMessageDialog(null, "«ÎÃÓ–¥“™…æ≥˝µƒ∂¡’ﬂ±‡∫≈£°", "œ˚œ¢", 1);
		}
	}
